...
if (!$db_connection) {
    ...
    fclose ($csv_handle);
    if ($size == 0) {
        echo "<p>Your search did not produced any result!</p>";
        unlink ($csv_handle);
    }
    else {
        echo '<p>Your search is ready to be <a href="', substr ($csv_filename, 14), '">downloaded</a>.</p>';
        echo '<p>This link is valid for <em>24 hours</em>.</p>';
    }
}
?>
</body>
